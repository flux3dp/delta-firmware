...
# from fluxmonitor.services.upnp import CODE_DISCOVER, \
#     CODE_SET_NETWORK, DEFAULT_PORT
# from fluxmonitor.services.upnp import UpnpService, UpnpSocket
#
#
...
#         self.w = UpnpService(self.server)
#
#     def tearDown(self):
#         self.w.shutdown()
#         self.w = None
...
#
#
# class UpnpServiceNetworkMonitorMixTest(unittest.TestCase):
#     """Test fluxmonitor.watcher.flux_upnp.UpnpService"""
#
#     def setUp(self):
#         U.clean_db()
#         self.cache = MemcacheTestClient()
#         self.w = UpnpService(ServerSimulator())
#
#     def tearDown(self):
#         self.w.shutdown()
#         self.w = None
