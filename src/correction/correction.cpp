...
static char __pyx_k_init_x[] = "init_x";
static char __pyx_k_init_y[] = "init_y";
static char __pyx_k_init_z[] = "init_z";
static char __pyx_k_result[] = "result";
static char __pyx_k_input_h[] = "input_h";
static char __pyx_k_input_x[] = "input_x";
static char __pyx_k_input_y[] = "input_y";
static char __pyx_k_input_z[] = "input_z";
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "fluxmonitor.misc.correction")) {
      if (unlikely(PyDict_SetItemString(modules, "fluxmonitor.misc.correction", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
